...
namespace TechJobsOO.Tests
{
    ...
    public class TestTask5
    {
        ...
        public void Test_TestToString_Starts_And_Ends_With_NewLine()
        {
            ...
            //setup
            string text = System.IO.File.ReadAllText("/Users/sonnienguyen/Desktop/LaunchCode/TechJobsOO/CSharp6-TechJobs-OO/TechJobsOO.Tests/StartsAndEndsWithNewLine.txt").ToString();
        ...
        public void Test_TestToStringHandlesEmptyField()
        {
            ...
            string text = System.IO.File.ReadAllText("/Users/sonnienguyen/Desktop/LaunchCode/TechJobsOO/CSharp6-TechJobs-OO/TechJobsOO.Tests/EmptyFieldTest.txt").ToString();
            var stringWriter = new StringWriter();
            Console.SetOut(stringWriter);
            var job = new RunTechJobs();
            job.RunProgram();
